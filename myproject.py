...
class mclass:
    ...
    def __init__(self,  window):
        ...
        self.boxa = Entry(self.fr1,width=10,borderwidth=3,bg="#e3e3e3")
        ...
        self.boxb = Entry(self.fr1,width=10,borderwidth=3,bg="#e3e3e3")
        ...
        self.res_prim = Label(self.fr1,textvariable=self.resp_txt,justify=RIGHT, anchor="w", width=10,borderwidth=3,bg="#e3e3e3")
        ...
        # Button
        self.button = Button (self.fr1, width =15,text="Afficher",bg="#e3e3e3", command=self.plot, font=("Arial", 12))
        ...
        self.boxinf = Entry(self.fr3,width=10,borderwidth=3,bg="#e3e3e3")
        ...
        self.boxsup = Entry(self.fr3,width=10,borderwidth=3,bg="#e3e3e3")
        ...
        self.res_ve = Label(self.fr3,textvariable=self.res_ve_txt,justify=RIGHT, anchor="w", width=10,borderwidth=3,bg="#e3e3e3")
        ...
        self.res_va = Label(self.fr3,textvariable=self.res_va_txt,justify=RIGHT, anchor="w", width=10,borderwidth=3,bg="#e3e3e3")
        ...
        self.res_e = Label(self.fr3,textvariable=self.res_e_txt,justify=RIGHT, anchor="w", width=10,borderwidth=3,bg="#e3e3e3")
        self.res_e.grid(sticky = W, row=8, column=1)
        

            # Button
        self.button_2 = Button (self.fr3, width =15,text="Afficher",bg="#e3e3e3", command=self.choice, font=("Arial", 12))
